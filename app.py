...
SQLALCHEMY_DATABASE_URI ='postgresql://eddah:eddah@localhost:5432/fyyur'
...
def search_venues():
  ...
  # search for "Music" should return "The Musical Hop" and "Park Square Live Music & Coffee"
   ...
   return render_template('pages/search_venues.html', results=response, searc_term=request.form.get('search_term', ''))
...
def create_venue_submission():
 ...
 #TODO:on unsuccessful b insert, flash an error insteaad
...
def create_artist_submission():
  # called upon submitting the new artist listing 
